...
function TestimonialCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-pink-200 p-6 sm:p-7 flex flex-col h-full hover:shadow-md transition-shadow duration-300">
      {/* Author — top */}
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 sm:py-32 bg-pink-50">
