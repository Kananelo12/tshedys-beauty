...
import { Sparkles, X, Menu, Lock } from "lucide-react";
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex">
              <Link href="/admin/login">
                <motion.span
                  className="px-4 py-2.5 rounded-full bg-linear-to-r from-purple-500 to-indigo-600 text-white font-semibold hover:shadow-lg transition-all duration-300 inline-flex items-center gap-2"
          ...
          {isOpen && (
            ...
            >
              <div className="px-4 pt-4 space-y-4">
                    ...
                    <Link
                      ...
                      className={`flex items-center gap-3 py-3 px-4 rounded-xl font-semibold transition-all ${
                        "isAdmin" in link && link.isAdmin
                          ? "bg-linear-to-r from-purple-500 to-indigo-600 text-white hover:shadow-lg"
                          : "bg-white/50 hover:bg-pink-100 text-charcoal-800"
                      }`}
                ...
                <Link
                  href="/book"
                  className="flex items-center justify-center gap-2 w-full text-center py-3 rounded-full bg-linear-to-r from-pink-500 to-rose-500 text-white font-bold shadow-pink-glow"
                  onClick={() => setIsOpen(false)}
                >
                  <Sparkles size={20} />
                  Book Appointment
