...
export default function Features() {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-pink-50 via-blush-50 to-purple-50 opacity-50" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h3 className="text-4xl md:text-5xl font-serif font-bold bg-gradient-to-r from-pink-600 via-rose-500 to-purple-600 bg-clip-text text-transparent mb-4">
            ✨ The Magic of Beauty
          </h3>
          <p className="text-lg text-charcoal-600 max-w-3xl mx-auto leading-relaxed">
            A curated menu of enchanting services designed to enhance your natural beauty and unleash your inner royalty.
          </p>
        </motion.div>
          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              >
                ...
                {/* Icon */}
                <motion.div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center mb-6 shadow-elevated`}
                  whileHover={{ 
                    rotate: 360,
                    scale: 1.1
                  }}
