...
async function handleReject(id: string, token: string) {
  ...
  return NextResponse.redirect(`${process.env.BASE_URL}/admin/bookings/success?status=rejected&bookingId=${id}`);
}
