                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm text-blush-600 hover:text-blush-700 break-all"
                      >
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="flex gap-3">
                      <a
                        ...
                        className="w-10 h-10 bg-pink-600 rounded-full flex items-center justify-center text-white hover:bg-pink-700 hover:shadow-lg transition-all duration-300 hover:scale-110"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="currentColor"
