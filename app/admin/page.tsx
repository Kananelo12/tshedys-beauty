      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <a href="/admin/bookings" className="text-sm text-sage-600">Manage →</a>
          </div>
          <Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a href="/admin/bookings" className="bg-white rounded-xl p-3 border border-gray-200 text-center hover:border-sage-500">New Booking</a>
            <a href="/admin/services" className="bg-white rounded-xl p-3 border border-gray-200 text-center hover:border-sage-500">Add Service</a>
            <a href="/admin/gallery" className="bg-white rounded-xl p-3 border border-gray-200 text-center hover:border-sage-500">Upload Image</a>
